...
<img src="/fun_line.jpeg" alt="line" style="width: 300px;"/>

</div>
<a href="https://lin.ee/lpYPloz" target="_blank">https://lin.ee/lpYPloz</a> <br />
<div class="text-body">
最後請點擊上方連結或掃描QR Code，<br />
加入FUN星球官方LINE，<br />
回傳「聯絡電話與小朋友稱呼」給我們，<br />
<code>
{{ phone}}，{{child_list.join(',')}}<br />
家長名稱：{{parent_line}}
</code><br/>
例：「0912345678，喬治」<br />
以便確認能夠聯繫到您🙏<br /><br />
